        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="block-heading-one">
                    <h3><i class="fa fa-angle-double-right color"></i> Informações sobre a acupuntura</h3>
                </div>

                <p>
                    Sua origem ocorreu na China há aproximadamente 4.500 anos. No entanto, apesar de sua antiguidade, esta ciência
                    milenar continua evoluindo e mostrando sua eficácia.<br><br>
                </p>
                ...
                <p>
                    ...
                    as agulhas são inseridas nos pontos de acupuntura, visando restabelecer a circulação energética, com isso,
                    levar o corpo a uma harmonia.
                </p>
                <br />
            </div>
            <div class="col-md-6 col-sm-6">
